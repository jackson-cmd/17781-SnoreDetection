...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void changePageText(id) {
    switch (id) {
      case 0:
        setState(() {
          title = "Detect Snore and help you";
          subtitle = "You can start to detect snore";
        });
        break;
      case 1:
        setState(() {
          title = "Bedtime analysis";
          subtitle =
              "Analyze when you sleep and how you sleep";
        });
        break;
      case 2:
        setState(() {
          title = "Sleep Music";
          subtitle =
              "Music will help you sleep better, and better sleep will not snore";
        });
        break;
      case 3:
        setState(() {
          title = "Your settings";
          subtitle =
              "Preference for your personal settings";
        });
        break;
      case 4:
        setState(() {
          title = "My data";
          subtitle =
              "Save you data locally or onlien";
        });
        break;
      default:
    }
